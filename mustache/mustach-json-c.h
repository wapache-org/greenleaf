 ...
 *
 * @template: the template string to instanciate 模板
 * @root:     the root json object to render     数据
 * @file:     the file where to write the result 结果
 *
 * Returns 
 * 0 in case of success, 
 * -1 with errno set in case of system error
 * an other negative value in case of error.
 */
