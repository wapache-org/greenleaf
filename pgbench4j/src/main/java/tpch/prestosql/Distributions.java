...
import static tpch.prestosql.DistributionLoader.loadDistribution;
...
public class Distributions
{
    ...
    private final Distribution nations2;
    private final Distribution q13a;
    private final Distribution q13b;
    ...
    public Distributions(Map<String, Distribution> distributions)
    {
        ...
        this.nations2 = getDistribution(distributions, "nations2");
        this.q13a = getDistribution(distributions, "q13a");
        this.q13b = getDistribution(distributions, "q13b");
    }
    ...
    public Distribution getNations2() {
        return nations2;
    }

    public Distribution getQ13a() {
        return q13a;
    }

    public Distribution getQ13b() {
        return q13b;
    }
    ...
    private static Distribution getDistribution(Map<String, Distribution> distributions, String name)
    {
        ...
        checkArgument(distribution != null, String.format("Distribution %s does not exist", name));
        return distribution;
    }
}
